...
if options.update_setup :
  ...
  ## apply horizontal template morphing for finer step sizes for limit calculation
    ...
    if "et" in config.channels:
        os.system("horizontal-morphing.py --categories='eleTau_2jet1tag_slice0,eleTau_2jet1tag_slice1,eleTau_2jet1tag_slice2,eleTau_2jet1tag_slice3,eleTau_2jet1tag_slice4,eleTau_2jet2tag_slice0,eleTau_2jet2tag_slice1,eleTau_2jet2tag_slice2,eleTau_2jet2tag_slice3,eleTau_2jet2tag_slice4' --samples='bbH{MASS}' --uncerts='CMS_scale_t_etau_8TeV' --masses='250,300' --step-size 10. -v {SETUP}/et/htt_et.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
        os.system("horizontal-morphing.py --categories='eleTau_2jet1tag_slice0,eleTau_2jet1tag_slice1,eleTau_2jet1tag_slice2,eleTau_2jet1tag_slice3,eleTau_2jet1tag_slice4,eleTau_2jet2tag_slice0,eleTau_2jet2tag_slice1,eleTau_2jet2tag_slice2,eleTau_2jet2tag_slice3,eleTau_2jet2tag_slice4' --samples='bbH{MASS}' --uncerts='CMS_scale_t_etau_8TeV' --masses='300,350' --step-size 10. -v {SETUP}/et/htt_et.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
    ##mt
    if "mt" in config.channels:
        os.system("horizontal-morphing.py --categories='muTau_2jet1tag_slice0,muTau_2jet1tag_slice1,muTau_2jet1tag_slice2,muTau_2jet1tag_slice3,muTau_2jet1tag_slice4,muTau_2jet2tag_slice0,muTau_2jet2tag_slice1,muTau_2jet2tag_slice2,muTau_2jet2tag_slice3,muTau_2jet2tag_slice4' --samples='bbH{MASS}' --uncerts='CMS_scale_t_mutau_8TeV' --masses='250,300' --step-size 10. -v {SETUP}/mt/htt_mt.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
        os.system("horizontal-morphing.py --categories='muTau_2jet1tag_slice0,muTau_2jet1tag_slice1,muTau_2jet1tag_slice2,muTau_2jet1tag_slice3,muTau_2jet1tag_slice4,muTau_2jet2tag_slice0,muTau_2jet2tag_slice1,muTau_2jet2tag_slice2,muTau_2jet2tag_slice3,muTau_2jet2tag_slice4' --samples='bbH{MASS}' --uncerts='CMS_scale_t_mutau_8TeV' --masses='300,350' --step-size 10. -v {SETUP}/mt/htt_mt.inputs-Hhh-8TeV.root".format(SETUP=setup, MASS="{MASS}"))
    ##tt
